                        ...
                        <tbody id="data-table-body">
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td class="text-center" style="display: flex; justify-content: center;">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('dosen.show', $value->uid) }}" class="btn mb-1 mr-1" style="background-color: #28a745; color: white; border-radius: 4px; padding: 5px 10px;" data-toggle="tooltip" title='Update'>
