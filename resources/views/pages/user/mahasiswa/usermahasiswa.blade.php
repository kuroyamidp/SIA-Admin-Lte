                        ...
                        <tbody style="text-align: center;">
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="display: flex; justify-content: center;">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('user-mahasiswa.show', $value->uid) }}" class="btn btn-warning mb-1 mr-1" style="border-radius: 4px; padding: 5px 10px;" data-toggle="tooltip" title='Update'>
                                        <i class="fas fa-pencil-alt"></i> <!-- Ikon pensil -->
                                    </a>

                                    <!-- Form Delete -->
                                    <form action="{{ route('user-mahasiswa.destroy', $value->uid) }}" method="post" class="delete-form" onsubmit="confirmDelete(event)">
                                        @method('DELETE')
                                        @csrf
